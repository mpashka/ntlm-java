There is example of usage NTLM-java to connect to ms lync server via SIP https://github.com/mpashka/ntlm-java/blob/master/ntlm-examples/sip/src/main/java/org/dvizuha/sip/ntlm/LyncConnector.java.
